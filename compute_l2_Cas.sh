...
for i in $files;do
	...
	annot=/opt/working/projects/prj_026_CRISPR/Cas/$1/annotation/$var.annot.gz ## prefix of annot.gz file, without chromosome number, which was refer to $var
	out=/opt/working/projects/prj_026_CRISPR/Cas/$1/annotation/$var
